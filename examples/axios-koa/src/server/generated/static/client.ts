...
export const UpdatePetSecurity = [{"petstore_auth":["write:pets","read:pets"]}]
...
export const GetPetByIdSecurity = [{"api_key":[]},{"petstore_auth":["write:pets","read:pets"]}]
...
export const UpdatePetWithFormSecurity = [{"petstore_auth":["write:pets","read:pets"]}]
...
export const DeletePetSecurity = [{"petstore_auth":["write:pets","read:pets"]}]
...
export const UploadFileSecurity = [{"petstore_auth":["write:pets","read:pets"]}]
...
export const FindPetsByStatusSecurity = [{"petstore_auth":["write:pets","read:pets"]}]

export const FindPetsByStatusResponse = {
  "schema": FindPetsByStatus,
  "status": 200
} as const
...
export const FindPetsByTagsSecurity = [{"petstore_auth":["write:pets","read:pets"]}]

export const FindPetsByTagsResponse = {
  "schema": FindPetsByTags,
  "status": 200
} as const
...
export const GetInventoryParameters = [
] as const
...
export type CreateUsersWithListInputResponse = typeof CreateUsersWithListInputResponse
...
export type CreateUsersWithListInputErrors = typeof CreateUsersWithListInputErrors
...
export const LogoutUserParameters = [
] as const
